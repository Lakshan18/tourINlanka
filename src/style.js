const style = {
    ...
    cardDefineAreaText: "text-white xs:text-[14px]",
    cardSmallText: "text-white xl:text-[13px] font-medium font-[Poppins]",
    subTopicAreaText: "text-[#] 2xl:text-[28px] xl:text-[28px] lg:text-[26px] text-[20px] font-semibold font-[Rubik]",
    subDefineAreaText: "text-[] 2xl:text-[18px] xl:text-[16px] lg:text-[14px] xs:text-[13px] md:text-[14px] sm:text-[15px] font-[Poppins]",
};
