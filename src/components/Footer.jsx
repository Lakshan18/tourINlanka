                    ...
                    >
                        ...
                        <div className="flex space-x-4 flex-row">
                            {[
                                ...
                                {
                                    name: 'instagram',
                                    url: 'https://www.instagram.com/tour.inlanka?igsh=MXd3NjlocDA0cTNqMA==&utm_source=ig_contact_invite',
                                ...
                                {
                                    name: 'whatsapp',
                                    url: 'https://wa.me/message/3QHNR4LKVZK3H1',
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <span className="text-gray-400 text-[15px] font-[Roboto]">+94 76 218 9803</span>
                            </div>
                            <div className="flex items-center space-x-3">
                                <svg className="h-5 w-5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <span className="text-gray-400 text-[15px] font-[Roboto]">tourinlankaofficial@gmail.com</span>
                            </div>
                        </div>
                    </motion.div>
